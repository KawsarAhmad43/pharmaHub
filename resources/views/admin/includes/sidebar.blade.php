<ul class="sidebar-nav" id="sidebar-nav">
        ...
        <ul id="users-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
                <a href="charts-chartjs.html">
                    <i class="bi bi-circle"></i><span>Manufacturers</span>
                </a>
            </li>
            <li>
                <a href="charts-apexcharts.html">
                    <i class="bi bi-circle"></i><span>Shoppers</span>
                </a>
            </li>
            <li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#medicines-nav" data-bs-toggle="collapse" href="#">
            <i class="bi bi-capsule-pill"></i><span>Medicine management</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="medicines-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
                <a href="charts-chartjs.html">
                    <i class="bi bi-circle"></i><span>Generic</span>
                </a>
            </li>
            <li>
                <a href="charts-apexcharts.html">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#shop-nav" data-bs-toggle="collapse" href="#">
            <i class="bi bi-shop"></i><span>Shop management</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="shop-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            <li>
                <a href="charts-chartjs.html">
                    <i class="bi bi-circle"></i><span>Shops</span>
                </a>
            </li>
            <li>
                <a href="charts-apexcharts.html">
                    <i class="bi bi-circle"></i><span>Shelves</span>
                </a>
            </li>
            <li>
                <a href="charts-echarts.html">
                    <i class="bi bi-circle"></i><span>Assign Medicine in Shelves</span>
                </a>
            </li>
        </ul>
    </li>
    ...
    <li class="nav-item">
        ...
        <ul id="order-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            ...
            <li>
                <a href="charts-echarts.html">
                    <i class="bi bi-circle"></i><span>Shop Setting</span>
                </a>
            </li>
        </ul>
    </li>
    {{--  --}}
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#delivery-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-truck"></i><span>Delivery management</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="delivery-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="charts-chartjs.html">
                        <i class="bi bi-circle"></i><span>Personal System</span>
                    </a>
                </li>
                <li>
                    <a href="charts-apexcharts.html">
                        <i class="bi bi-circle"></i><span>Third Party</span>
                    </a>
                </li>
                <li>
                    <a href="charts-echarts.html">
                        <i class="bi bi-circle"></i><span>Request Service</span>
                    </a>
                </li>
                <li>
                    <a href="charts-echarts.html">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#promotion-nav" data-bs-toggle="collapse" href="#">
            <i class="bi bi-badge-ad"></i><span>Promotions</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="promotion-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            ...
            <li>
                <a href="charts-apexcharts.html">
                    <i class="bi bi-circle"></i><span>Promote</span>
                </a>
            </li>
            <li>
                <a href="charts-echarts.html">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#expense-nav" data-bs-toggle="collapse" href="#">
            <i class="bi bi-currency-dollar"></i><span>Expense Management</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
